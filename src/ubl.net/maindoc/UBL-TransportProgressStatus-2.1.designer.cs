...
namespace Oasis.Ubl.v21 {
    ...
    public partial class TransportProgressStatusType : System.ComponentModel.INotifyPropertyChanged {
        ...
        private ObservableCollection<TransportScheduleType> transportScheduleField;
        ...
        public StatusAvailableIndicatorType StatusAvailableIndicator {
            ...
            set {
                if ((this.statusAvailableIndicatorField != null)) {
                    if ((statusAvailableIndicatorField.Equals(value) != true)) {
                        this.statusAvailableIndicatorField = value;
                        this.OnPropertyChanged("StatusAvailableIndicator");
                    }
                }
                else {
                    this.statusAvailableIndicatorField = value;
        ...
        public PartyType SourceIssuerParty {
            ...
            set {
                if ((this.sourceIssuerPartyField != null)) {
                    if ((sourceIssuerPartyField.Equals(value) != true)) {
                        this.sourceIssuerPartyField = value;
                        this.OnPropertyChanged("SourceIssuerParty");
                    }
                }
                else {
                    this.sourceIssuerPartyField = value;
        ...
        public DocumentReferenceType TransportProgressStatusRequestDocumentReference {
            ...
            set {
                if ((this.transportProgressStatusRequestDocumentReferenceField != null)) {
                    if ((transportProgressStatusRequestDocumentReferenceField.Equals(value) != true)) {
                        this.transportProgressStatusRequestDocumentReferenceField = value;
                        this.OnPropertyChanged("TransportProgressStatusRequestDocumentReference");
                    }
                }
                else {
                    this.transportProgressStatusRequestDocumentReferenceField = value;
        ...
        public TransportMeansType TransportMeans {
            ...
            set {
                if ((this.transportMeansField != null)) {
                    if ((transportMeansField.Equals(value) != true)) {
                        this.transportMeansField = value;
                        this.OnPropertyChanged("TransportMeans");
                    }
                }
                else {
                    this.transportMeansField = value;
        ...
        public ObservableCollection<TransportScheduleType> TransportSchedule {
            get {
                return this.transportScheduleField;
            }
            set {
                if ((this.transportScheduleField != null)) {
                    if ((transportScheduleField.Equals(value) != true)) {
                        this.transportScheduleField = value;
                        this.OnPropertyChanged("TransportSchedule");
                    }
                }
                else {
                    this.transportScheduleField = value;
        ...
        private static System.Xml.Serialization.XmlSerializer Serializer {
            get {
                if ((serializer == null)) {
                    serializer = new System.Xml.Serialization.XmlSerializer(typeof(TransportProgressStatusType));
                }
                return serializer;
            }
        }
        ...
        /// <summary>
        /// Serializes current TransportProgressStatusType object into an XML document
        /// </summary>
        ...
        /// <summary>
        /// Deserializes workflow markup into an TransportProgressStatusType object
        /// </summary>
        /// <param name="xml">string workflow markup to deserialize</param>
        /// <param name="obj">Output TransportProgressStatusType object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool Deserialize(string xml, out TransportProgressStatusType obj, out System.Exception exception) {
            exception = null;
            obj = default(TransportProgressStatusType);
            try {
                obj = Deserialize(xml);
                return true;
            }
        ...
        public static bool Deserialize(string xml, out TransportProgressStatusType obj) {
            System.Exception exception = null;
            return Deserialize(xml, out obj, out exception);
        }
        
        public static TransportProgressStatusType Deserialize(string xml) {
            System.IO.StringReader stringReader = null;
            try {
                stringReader = new System.IO.StringReader(xml);
                return ((TransportProgressStatusType)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally {
        ...
        /// <summary>
        /// Serializes current TransportProgressStatusType object into file
        /// </summary>
        ...
        /// <summary>
        /// Deserializes xml markup from file into an TransportProgressStatusType object
        /// </summary>
        /// <param name="fileName">string xml file to load and deserialize</param>
        /// <param name="obj">Output TransportProgressStatusType object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, out TransportProgressStatusType obj, out System.Exception exception) {
            exception = null;
            obj = default(TransportProgressStatusType);
            try {
        ...
        public static bool LoadFromFile(string fileName, out TransportProgressStatusType obj) {
            System.Exception exception = null;
            return LoadFromFile(fileName, out obj, out exception);
        }
        
        public static TransportProgressStatusType LoadFromFile(string fileName) {
        ...
        #region Clone method
        /// <summary>
        /// Create a clone of this TransportProgressStatusType object
        /// </summary>
        public virtual TransportProgressStatusType Clone() {
            return ((TransportProgressStatusType)(this.MemberwiseClone()));
        }
        #endregion
    }
}
