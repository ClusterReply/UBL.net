...
namespace Oasis.Ubl.v21 {
    ...
    public partial class OrderResponseSimpleType : System.ComponentModel.INotifyPropertyChanged {
        ...
        private ObservableCollection<RejectionNoteType> rejectionNoteField;
        ...
        public AcceptedIndicatorType AcceptedIndicator {
            ...
            set {
                if ((this.acceptedIndicatorField != null)) {
                    if ((acceptedIndicatorField.Equals(value) != true)) {
                        this.acceptedIndicatorField = value;
                        this.OnPropertyChanged("AcceptedIndicator");
                    }
                }
                else {
                    this.acceptedIndicatorField = value;
        ...
        public ObservableCollection<RejectionNoteType> RejectionNote {
            get {
                return this.rejectionNoteField;
            }
            set {
                if ((this.rejectionNoteField != null)) {
                    if ((rejectionNoteField.Equals(value) != true)) {
                        this.rejectionNoteField = value;
                        this.OnPropertyChanged("RejectionNote");
                    }
                }
                else {
                    this.rejectionNoteField = value;
        ...
        private static System.Xml.Serialization.XmlSerializer Serializer {
            get {
                if ((serializer == null)) {
                    serializer = new System.Xml.Serialization.XmlSerializer(typeof(OrderResponseSimpleType));
                }
                return serializer;
            }
        }
        ...
        /// <summary>
        /// Serializes current OrderResponseSimpleType object into an XML document
        /// </summary>
        ...
        /// <summary>
        /// Deserializes workflow markup into an OrderResponseSimpleType object
        /// </summary>
        /// <param name="xml">string workflow markup to deserialize</param>
        /// <param name="obj">Output OrderResponseSimpleType object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool Deserialize(string xml, out OrderResponseSimpleType obj, out System.Exception exception) {
            exception = null;
            obj = default(OrderResponseSimpleType);
            try {
                obj = Deserialize(xml);
                return true;
            }
        ...
        public static bool Deserialize(string xml, out OrderResponseSimpleType obj) {
            System.Exception exception = null;
            return Deserialize(xml, out obj, out exception);
        }
        
        public static OrderResponseSimpleType Deserialize(string xml) {
            System.IO.StringReader stringReader = null;
            try {
                stringReader = new System.IO.StringReader(xml);
                return ((OrderResponseSimpleType)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally {
        ...
        /// <summary>
        /// Serializes current OrderResponseSimpleType object into file
        /// </summary>
        ...
        /// <summary>
        /// Deserializes xml markup from file into an OrderResponseSimpleType object
        /// </summary>
        /// <param name="fileName">string xml file to load and deserialize</param>
        /// <param name="obj">Output OrderResponseSimpleType object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, out OrderResponseSimpleType obj, out System.Exception exception) {
            exception = null;
            obj = default(OrderResponseSimpleType);
            try {
        ...
        public static bool LoadFromFile(string fileName, out OrderResponseSimpleType obj) {
            System.Exception exception = null;
            return LoadFromFile(fileName, out obj, out exception);
        }
        
        public static OrderResponseSimpleType LoadFromFile(string fileName) {
        ...
        #region Clone method
        /// <summary>
        /// Create a clone of this OrderResponseSimpleType object
        /// </summary>
        public virtual OrderResponseSimpleType Clone() {
            return ((OrderResponseSimpleType)(this.MemberwiseClone()));
        }
        #endregion
    }
}
