...
namespace Oasis.Ubl.v21 {
    ...
    public partial class TradeItemLocationProfileType : System.ComponentModel.INotifyPropertyChanged {
        ...
        private ObservableCollection<ItemManagementProfileType> itemManagementProfileField;
        ...
        public ProfileStatusCodeType ProfileStatusCode {
            get {
                return this.profileStatusCodeField;
            }
            set {
                if ((this.profileStatusCodeField != null)) {
                    if ((profileStatusCodeField.Equals(value) != true)) {
                        this.profileStatusCodeField = value;
                        this.OnPropertyChanged("ProfileStatusCode");
                    }
                }
                else {
                    this.profileStatusCodeField = value;
        ...
        public ObservableCollection<ItemManagementProfileType> ItemManagementProfile {
            get {
                return this.itemManagementProfileField;
            }
            set {
                if ((this.itemManagementProfileField != null)) {
                    if ((itemManagementProfileField.Equals(value) != true)) {
                        this.itemManagementProfileField = value;
                        this.OnPropertyChanged("ItemManagementProfile");
                    }
                }
                else {
                    this.itemManagementProfileField = value;
        ...
        private static System.Xml.Serialization.XmlSerializer Serializer {
            get {
                if ((serializer == null)) {
                    serializer = new System.Xml.Serialization.XmlSerializer(typeof(TradeItemLocationProfileType));
                }
                return serializer;
            }
        }
        ...
        /// <summary>
        /// Serializes current TradeItemLocationProfileType object into an XML document
        /// </summary>
        ...
        /// <summary>
        /// Deserializes workflow markup into an TradeItemLocationProfileType object
        /// </summary>
        /// <param name="xml">string workflow markup to deserialize</param>
        /// <param name="obj">Output TradeItemLocationProfileType object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool Deserialize(string xml, out TradeItemLocationProfileType obj, out System.Exception exception) {
            exception = null;
            obj = default(TradeItemLocationProfileType);
            try {
                obj = Deserialize(xml);
                return true;
            }
        ...
        public static bool Deserialize(string xml, out TradeItemLocationProfileType obj) {
            System.Exception exception = null;
            return Deserialize(xml, out obj, out exception);
        }
        
        public static TradeItemLocationProfileType Deserialize(string xml) {
            System.IO.StringReader stringReader = null;
            try {
                stringReader = new System.IO.StringReader(xml);
                return ((TradeItemLocationProfileType)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally {
        ...
        /// <summary>
        /// Serializes current TradeItemLocationProfileType object into file
        /// </summary>
        ...
        /// <summary>
        /// Deserializes xml markup from file into an TradeItemLocationProfileType object
        /// </summary>
        /// <param name="fileName">string xml file to load and deserialize</param>
        /// <param name="obj">Output TradeItemLocationProfileType object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, out TradeItemLocationProfileType obj, out System.Exception exception) {
            exception = null;
            obj = default(TradeItemLocationProfileType);
            try {
        ...
        public static bool LoadFromFile(string fileName, out TradeItemLocationProfileType obj) {
            System.Exception exception = null;
            return LoadFromFile(fileName, out obj, out exception);
        }
        
        public static TradeItemLocationProfileType LoadFromFile(string fileName) {
        ...
        #region Clone method
        /// <summary>
        /// Create a clone of this TradeItemLocationProfileType object
        /// </summary>
        public virtual TradeItemLocationProfileType Clone() {
            return ((TradeItemLocationProfileType)(this.MemberwiseClone()));
        }
        #endregion
    }
}
