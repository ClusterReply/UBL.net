...
namespace Oasis.Ubl.v21 {
    ...
    public partial class OrderCancellationType : System.ComponentModel.INotifyPropertyChanged {
        ...
        private static System.Xml.Serialization.XmlSerializer Serializer {
            get {
                if ((serializer == null)) {
                    serializer = new System.Xml.Serialization.XmlSerializer(typeof(OrderCancellationType));
                }
                return serializer;
            }
        }
        ...
        /// <summary>
        /// Serializes current OrderCancellationType object into an XML document
        /// </summary>
        ...
        /// <summary>
        /// Deserializes workflow markup into an OrderCancellationType object
        /// </summary>
        /// <param name="xml">string workflow markup to deserialize</param>
        /// <param name="obj">Output OrderCancellationType object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool Deserialize(string xml, out OrderCancellationType obj, out System.Exception exception) {
            exception = null;
            obj = default(OrderCancellationType);
            try {
                obj = Deserialize(xml);
                return true;
            }
        ...
        public static bool Deserialize(string xml, out OrderCancellationType obj) {
            System.Exception exception = null;
            return Deserialize(xml, out obj, out exception);
        }
        
        public static OrderCancellationType Deserialize(string xml) {
            System.IO.StringReader stringReader = null;
            try {
                stringReader = new System.IO.StringReader(xml);
                return ((OrderCancellationType)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally {
        ...
        /// <summary>
        /// Serializes current OrderCancellationType object into file
        /// </summary>
        ...
        /// <summary>
        /// Deserializes xml markup from file into an OrderCancellationType object
        /// </summary>
        /// <param name="fileName">string xml file to load and deserialize</param>
        /// <param name="obj">Output OrderCancellationType object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, out OrderCancellationType obj, out System.Exception exception) {
            exception = null;
            obj = default(OrderCancellationType);
            try {
        ...
        public static bool LoadFromFile(string fileName, out OrderCancellationType obj) {
            System.Exception exception = null;
            return LoadFromFile(fileName, out obj, out exception);
        }
        
        public static OrderCancellationType LoadFromFile(string fileName) {
        ...
        #region Clone method
        /// <summary>
        /// Create a clone of this OrderCancellationType object
        /// </summary>
        public virtual OrderCancellationType Clone() {
            return ((OrderCancellationType)(this.MemberwiseClone()));
        }
        #endregion
    }
}
