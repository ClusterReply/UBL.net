...
namespace Oasis.Ubl.v21 {
    ...
    public partial class ContractNoticeType : System.ComponentModel.INotifyPropertyChanged {
        ...
        private RequestedPublicationDateType requestedPublicationDateField;
        
        private ObservableCollection<RegulatoryDomainType> regulatoryDomainField;
        
        private PeriodType frequencyPeriodField;
        
        private ObservableCollection<SignatureType> signatureField;
        
        private ContractingPartyType contractingPartyField;
        
        private ObservableCollection<CustomerPartyType> originatorCustomerPartyField;
        ...
        public RequestedPublicationDateType RequestedPublicationDate {
            get {
                return this.requestedPublicationDateField;
            }
            set {
                if ((this.requestedPublicationDateField != null)) {
                    if ((requestedPublicationDateField.Equals(value) != true)) {
                        this.requestedPublicationDateField = value;
                        this.OnPropertyChanged("RequestedPublicationDate");
                    }
                }
                else {
                    this.requestedPublicationDateField = value;
        ...
        public PeriodType FrequencyPeriod {
            get {
                return this.frequencyPeriodField;
            }
            set {
                if ((this.frequencyPeriodField != null)) {
                    if ((frequencyPeriodField.Equals(value) != true)) {
                        this.frequencyPeriodField = value;
                        this.OnPropertyChanged("FrequencyPeriod");
                    }
                }
                else {
                    this.frequencyPeriodField = value;
        ...
        public ObservableCollection<CustomerPartyType> OriginatorCustomerParty {
            get {
        ...
        private static System.Xml.Serialization.XmlSerializer Serializer {
            get {
                if ((serializer == null)) {
                    serializer = new System.Xml.Serialization.XmlSerializer(typeof(ContractNoticeType));
                }
                return serializer;
            }
        }
        ...
        /// <summary>
        /// Serializes current ContractNoticeType object into an XML document
        /// </summary>
        ...
        /// <summary>
        /// Deserializes workflow markup into an ContractNoticeType object
        /// </summary>
        /// <param name="xml">string workflow markup to deserialize</param>
        /// <param name="obj">Output ContractNoticeType object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool Deserialize(string xml, out ContractNoticeType obj, out System.Exception exception) {
            exception = null;
            obj = default(ContractNoticeType);
            try {
                obj = Deserialize(xml);
                return true;
            }
        ...
        public static bool Deserialize(string xml, out ContractNoticeType obj) {
            System.Exception exception = null;
            return Deserialize(xml, out obj, out exception);
        }
        
        public static ContractNoticeType Deserialize(string xml) {
            System.IO.StringReader stringReader = null;
            try {
                stringReader = new System.IO.StringReader(xml);
                return ((ContractNoticeType)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally {
        ...
        /// <summary>
        /// Serializes current ContractNoticeType object into file
        /// </summary>
        ...
        /// <summary>
        /// Deserializes xml markup from file into an ContractNoticeType object
        /// </summary>
        /// <param name="fileName">string xml file to load and deserialize</param>
        /// <param name="obj">Output ContractNoticeType object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, out ContractNoticeType obj, out System.Exception exception) {
            exception = null;
            obj = default(ContractNoticeType);
            try {
        ...
        public static bool LoadFromFile(string fileName, out ContractNoticeType obj) {
            System.Exception exception = null;
            return LoadFromFile(fileName, out obj, out exception);
        }
        
        public static ContractNoticeType LoadFromFile(string fileName) {
        ...
        #region Clone method
        /// <summary>
        /// Create a clone of this ContractNoticeType object
        /// </summary>
        public virtual ContractNoticeType Clone() {
            return ((ContractNoticeType)(this.MemberwiseClone()));
        }
        #endregion
    }
}
