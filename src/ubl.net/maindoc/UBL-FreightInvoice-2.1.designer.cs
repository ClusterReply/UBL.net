...
namespace Oasis.Ubl.v21 {
    ...
    public partial class FreightInvoiceType : System.ComponentModel.INotifyPropertyChanged {
        ...
        private static System.Xml.Serialization.XmlSerializer Serializer {
            get {
                if ((serializer == null)) {
                    serializer = new System.Xml.Serialization.XmlSerializer(typeof(FreightInvoiceType));
                }
                return serializer;
            }
        }
        ...
        /// <summary>
        /// Serializes current FreightInvoiceType object into an XML document
        /// </summary>
        ...
        /// <summary>
        /// Deserializes workflow markup into an FreightInvoiceType object
        /// </summary>
        /// <param name="xml">string workflow markup to deserialize</param>
        /// <param name="obj">Output FreightInvoiceType object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool Deserialize(string xml, out FreightInvoiceType obj, out System.Exception exception) {
            exception = null;
            obj = default(FreightInvoiceType);
            try {
                obj = Deserialize(xml);
                return true;
            }
        ...
        public static bool Deserialize(string xml, out FreightInvoiceType obj) {
            System.Exception exception = null;
            return Deserialize(xml, out obj, out exception);
        }
        
        public static FreightInvoiceType Deserialize(string xml) {
            System.IO.StringReader stringReader = null;
            try {
                stringReader = new System.IO.StringReader(xml);
                return ((FreightInvoiceType)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally {
        ...
        /// <summary>
        /// Serializes current FreightInvoiceType object into file
        /// </summary>
        ...
        /// <summary>
        /// Deserializes xml markup from file into an FreightInvoiceType object
        /// </summary>
        /// <param name="fileName">string xml file to load and deserialize</param>
        /// <param name="obj">Output FreightInvoiceType object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, out FreightInvoiceType obj, out System.Exception exception) {
            exception = null;
            obj = default(FreightInvoiceType);
            try {
        ...
        public static bool LoadFromFile(string fileName, out FreightInvoiceType obj) {
            System.Exception exception = null;
            return LoadFromFile(fileName, out obj, out exception);
        }
        
        public static FreightInvoiceType LoadFromFile(string fileName) {
        ...
        #region Clone method
        /// <summary>
        /// Create a clone of this FreightInvoiceType object
        /// </summary>
        public virtual FreightInvoiceType Clone() {
            return ((FreightInvoiceType)(this.MemberwiseClone()));
        }
        #endregion
    }
}
