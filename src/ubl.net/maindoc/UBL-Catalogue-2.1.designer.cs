...
namespace Oasis.Ubl.v21 {
    ...
    public partial class CatalogueType : System.ComponentModel.INotifyPropertyChanged {
        ...
        private ObservableCollection<TradingTermsType> tradingTermsField;
        
        private ObservableCollection<CatalogueLineType> catalogueLineField;
        ...
        public CatalogueReferenceType SourceCatalogueReference {
            get {
                return this.sourceCatalogueReferenceField;
            }
            set {
                if ((this.sourceCatalogueReferenceField != null)) {
                    if ((sourceCatalogueReferenceField.Equals(value) != true)) {
                        this.sourceCatalogueReferenceField = value;
                        this.OnPropertyChanged("SourceCatalogueReference");
                    }
                }
                else {
                    this.sourceCatalogueReferenceField = value;
        ...
        public ObservableCollection<TradingTermsType> TradingTerms {
            get {
        ...
        public ObservableCollection<CatalogueLineType> CatalogueLine {
            get {
                return this.catalogueLineField;
            }
            set {
                if ((this.catalogueLineField != null)) {
                    if ((catalogueLineField.Equals(value) != true)) {
                        this.catalogueLineField = value;
                        this.OnPropertyChanged("CatalogueLine");
                    }
                }
                else {
                    this.catalogueLineField = value;
        ...
        private static System.Xml.Serialization.XmlSerializer Serializer {
            get {
                if ((serializer == null)) {
                    serializer = new System.Xml.Serialization.XmlSerializer(typeof(CatalogueType));
                }
                return serializer;
            }
        }
        ...
        /// <summary>
        /// Serializes current CatalogueType object into an XML document
        /// </summary>
        ...
        /// <summary>
        /// Deserializes workflow markup into an CatalogueType object
        /// </summary>
        /// <param name="xml">string workflow markup to deserialize</param>
        /// <param name="obj">Output CatalogueType object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool Deserialize(string xml, out CatalogueType obj, out System.Exception exception) {
            exception = null;
            obj = default(CatalogueType);
            try {
                obj = Deserialize(xml);
                return true;
            }
        ...
        public static bool Deserialize(string xml, out CatalogueType obj) {
            System.Exception exception = null;
            return Deserialize(xml, out obj, out exception);
        }
        
        public static CatalogueType Deserialize(string xml) {
            System.IO.StringReader stringReader = null;
            try {
                stringReader = new System.IO.StringReader(xml);
                return ((CatalogueType)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally {
        ...
        /// <summary>
        /// Serializes current CatalogueType object into file
        /// </summary>
        ...
        /// <summary>
        /// Deserializes xml markup from file into an CatalogueType object
        /// </summary>
        /// <param name="fileName">string xml file to load and deserialize</param>
        /// <param name="obj">Output CatalogueType object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, out CatalogueType obj, out System.Exception exception) {
            exception = null;
            obj = default(CatalogueType);
            try {
        ...
        public static bool LoadFromFile(string fileName, out CatalogueType obj) {
            System.Exception exception = null;
            return LoadFromFile(fileName, out obj, out exception);
        }
        
        public static CatalogueType LoadFromFile(string fileName) {
        ...
        #region Clone method
        /// <summary>
        /// Create a clone of this CatalogueType object
        /// </summary>
        public virtual CatalogueType Clone() {
            return ((CatalogueType)(this.MemberwiseClone()));
        }
        #endregion
    }
}
