...
namespace Oasis.Ubl.v21 {
    ...
    public partial class AwardedNotificationType : System.ComponentModel.INotifyPropertyChanged {
        ...
        private ObservableCollection<FinancialGuaranteeType> finalFinancialGuaranteeField;
        
        private ObservableCollection<SignatureType> signatureField;
        
        private static System.Xml.Serialization.XmlSerializer serializer;
        
        public AwardedNotificationType() {
            this.signatureField = new ObservableCollection<SignatureType>();
            this.finalFinancialGuaranteeField = new ObservableCollection<FinancialGuaranteeType>();
        ...
        public ObservableCollection<FinancialGuaranteeType> FinalFinancialGuarantee {
            get {
                return this.finalFinancialGuaranteeField;
            }
            set {
                if ((this.finalFinancialGuaranteeField != null)) {
                    if ((finalFinancialGuaranteeField.Equals(value) != true)) {
                        this.finalFinancialGuaranteeField = value;
                        this.OnPropertyChanged("FinalFinancialGuarantee");
                    }
                }
                else {
                    this.finalFinancialGuaranteeField = value;
        ...
        private static System.Xml.Serialization.XmlSerializer Serializer {
            get {
                if ((serializer == null)) {
                    serializer = new System.Xml.Serialization.XmlSerializer(typeof(AwardedNotificationType));
                }
                return serializer;
            }
        }
        ...
        /// <summary>
        /// Serializes current AwardedNotificationType object into an XML document
        /// </summary>
        ...
        /// <summary>
        /// Deserializes workflow markup into an AwardedNotificationType object
        /// </summary>
        /// <param name="xml">string workflow markup to deserialize</param>
        /// <param name="obj">Output AwardedNotificationType object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool Deserialize(string xml, out AwardedNotificationType obj, out System.Exception exception) {
            exception = null;
            obj = default(AwardedNotificationType);
            try {
                obj = Deserialize(xml);
                return true;
            }
        ...
        public static bool Deserialize(string xml, out AwardedNotificationType obj) {
            System.Exception exception = null;
            return Deserialize(xml, out obj, out exception);
        }
        
        public static AwardedNotificationType Deserialize(string xml) {
            System.IO.StringReader stringReader = null;
            try {
                stringReader = new System.IO.StringReader(xml);
                return ((AwardedNotificationType)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally {
        ...
        /// <summary>
        /// Serializes current AwardedNotificationType object into file
        /// </summary>
        ...
        /// <summary>
        /// Deserializes xml markup from file into an AwardedNotificationType object
        /// </summary>
        /// <param name="fileName">string xml file to load and deserialize</param>
        /// <param name="obj">Output AwardedNotificationType object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, out AwardedNotificationType obj, out System.Exception exception) {
            exception = null;
            obj = default(AwardedNotificationType);
            try {
        ...
        public static bool LoadFromFile(string fileName, out AwardedNotificationType obj) {
            System.Exception exception = null;
            return LoadFromFile(fileName, out obj, out exception);
        }
        
        public static AwardedNotificationType LoadFromFile(string fileName) {
        ...
        #region Clone method
        /// <summary>
        /// Create a clone of this AwardedNotificationType object
        /// </summary>
        public virtual AwardedNotificationType Clone() {
            return ((AwardedNotificationType)(this.MemberwiseClone()));
        }
        #endregion
    }
}
