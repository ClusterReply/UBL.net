...
namespace Oasis.Ubl.v21 {
    ...
    public partial class ExceptionNotificationType : System.ComponentModel.INotifyPropertyChanged {
        ...
        private ObservableCollection<ExceptionNotificationLineType> exceptionNotificationLineField;
        ...
        public PeriodType ExceptionObservationPeriod {
            ...
            set {
                if ((this.exceptionObservationPeriodField != null)) {
                    if ((exceptionObservationPeriodField.Equals(value) != true)) {
                        this.exceptionObservationPeriodField = value;
                        this.OnPropertyChanged("ExceptionObservationPeriod");
                    }
                }
                else {
                    this.exceptionObservationPeriodField = value;
        ...
        public ObservableCollection<ExceptionNotificationLineType> ExceptionNotificationLine {
            get {
                return this.exceptionNotificationLineField;
            }
            set {
                if ((this.exceptionNotificationLineField != null)) {
                    if ((exceptionNotificationLineField.Equals(value) != true)) {
                        this.exceptionNotificationLineField = value;
                        this.OnPropertyChanged("ExceptionNotificationLine");
                    }
                }
                else {
                    this.exceptionNotificationLineField = value;
        ...
        private static System.Xml.Serialization.XmlSerializer Serializer {
            get {
                if ((serializer == null)) {
                    serializer = new System.Xml.Serialization.XmlSerializer(typeof(ExceptionNotificationType));
                }
                return serializer;
            }
        }
        ...
        /// <summary>
        /// Serializes current ExceptionNotificationType object into an XML document
        /// </summary>
        ...
        /// <summary>
        /// Deserializes workflow markup into an ExceptionNotificationType object
        /// </summary>
        /// <param name="xml">string workflow markup to deserialize</param>
        /// <param name="obj">Output ExceptionNotificationType object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool Deserialize(string xml, out ExceptionNotificationType obj, out System.Exception exception) {
            exception = null;
            obj = default(ExceptionNotificationType);
            try {
                obj = Deserialize(xml);
                return true;
            }
        ...
        public static bool Deserialize(string xml, out ExceptionNotificationType obj) {
            System.Exception exception = null;
            return Deserialize(xml, out obj, out exception);
        }
        
        public static ExceptionNotificationType Deserialize(string xml) {
            System.IO.StringReader stringReader = null;
            try {
                stringReader = new System.IO.StringReader(xml);
                return ((ExceptionNotificationType)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally {
        ...
        /// <summary>
        /// Serializes current ExceptionNotificationType object into file
        /// </summary>
        ...
        /// <summary>
        /// Deserializes xml markup from file into an ExceptionNotificationType object
        /// </summary>
        /// <param name="fileName">string xml file to load and deserialize</param>
        /// <param name="obj">Output ExceptionNotificationType object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, out ExceptionNotificationType obj, out System.Exception exception) {
            exception = null;
            obj = default(ExceptionNotificationType);
            try {
        ...
        public static bool LoadFromFile(string fileName, out ExceptionNotificationType obj) {
            System.Exception exception = null;
            return LoadFromFile(fileName, out obj, out exception);
        }
        
        public static ExceptionNotificationType LoadFromFile(string fileName) {
        ...
        #region Clone method
        /// <summary>
        /// Create a clone of this ExceptionNotificationType object
        /// </summary>
        public virtual ExceptionNotificationType Clone() {
            return ((ExceptionNotificationType)(this.MemberwiseClone()));
        }
        #endregion
    }
}
