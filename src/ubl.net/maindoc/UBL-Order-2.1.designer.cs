...
namespace Oasis.Ubl.v21 {
    ...
    public partial class OrderType : System.ComponentModel.INotifyPropertyChanged {
        ...
        private CatalogueReferenceType catalogueReferenceField;
        ...
        public OrderTypeCodeType OrderTypeCode {
            ...
            set {
                if ((this.orderTypeCodeField != null)) {
                    if ((orderTypeCodeField.Equals(value) != true)) {
                        this.orderTypeCodeField = value;
                        this.OnPropertyChanged("OrderTypeCode");
                    }
                }
                else {
                    this.orderTypeCodeField = value;
        ...
        public CatalogueReferenceType CatalogueReference {
            ...
            set {
                if ((this.catalogueReferenceField != null)) {
                    if ((catalogueReferenceField.Equals(value) != true)) {
                        this.catalogueReferenceField = value;
                        this.OnPropertyChanged("CatalogueReference");
                    }
                }
                else {
                    this.catalogueReferenceField = value;
        ...
        #region Clone method
        /// <summary>
        /// Create a clone of this OrderType object
        /// </summary>
        public virtual OrderType Clone() {
