...
namespace Oasis.Ubl.v21 {
    ...
    public partial class CreditNoteType : System.ComponentModel.INotifyPropertyChanged {
        ...
        public CreditNoteType() {
            ...
            this.creditNoteTypeCodeField = new CreditNoteTypeCodeType();
        ...
        public CreditNoteTypeCodeType CreditNoteTypeCode {
            ...
            set {
                if ((this.creditNoteTypeCodeField != null)) {
                    if ((creditNoteTypeCodeField.Equals(value) != true)) {
                        this.creditNoteTypeCodeField = value;
                        this.OnPropertyChanged("CreditNoteTypeCode");
                    }
                }
                else {
                    this.creditNoteTypeCodeField = value;
        ...
        /// <summary>
        /// Serializes current CreditNoteType object into an XML document
        /// </summary>
        ...
        /// <summary>
        /// Deserializes workflow markup into an CreditNoteType object
        /// </summary>
        /// <param name="xml">string workflow markup to deserialize</param>
        /// <param name="obj">Output CreditNoteType object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool Deserialize(string xml, out CreditNoteType obj, out System.Exception exception) {
            exception = null;
            obj = default(CreditNoteType);
            try {
                obj = Deserialize(xml);
                return true;
            }
        ...
        public static bool Deserialize(string xml, out CreditNoteType obj) {
        ...
        /// <summary>
        /// Serializes current CreditNoteType object into file
        /// </summary>
        ...
        /// <summary>
        /// Deserializes xml markup from file into an CreditNoteType object
        /// </summary>
        /// <param name="fileName">string xml file to load and deserialize</param>
        /// <param name="obj">Output CreditNoteType object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, out CreditNoteType obj, out System.Exception exception) {
            exception = null;
            obj = default(CreditNoteType);
            try {
        ...
        public static bool LoadFromFile(string fileName, out CreditNoteType obj) {
            System.Exception exception = null;
            return LoadFromFile(fileName, out obj, out exception);
        }
        
        public static CreditNoteType LoadFromFile(string fileName) {
        ...
        #region Clone method
        /// <summary>
        /// Create a clone of this CreditNoteType object
        /// </summary>
        public virtual CreditNoteType Clone() {
            return ((CreditNoteType)(this.MemberwiseClone()));
        }
        #endregion
    }
}
