...
namespace Oasis.Ubl.v21 {
    ...
    public partial class TendererQualificationType : System.ComponentModel.INotifyPropertyChanged {
        ...
        private ObservableCollection<TendererPartyQualificationType> tendererPartyQualificationField;
        
        private ContractingPartyType contractingPartyField;
        
        private ObservableCollection<EvidenceType> evidenceField;
        ...
        public ObservableCollection<TendererPartyQualificationType> TendererPartyQualification {
            get {
                return this.tendererPartyQualificationField;
            }
            set {
                if ((this.tendererPartyQualificationField != null)) {
                    if ((tendererPartyQualificationField.Equals(value) != true)) {
                        this.tendererPartyQualificationField = value;
                        this.OnPropertyChanged("TendererPartyQualification");
                    }
                }
                else {
                    this.tendererPartyQualificationField = value;
        ...
        public ObservableCollection<EvidenceType> Evidence {
            get {
                return this.evidenceField;
            }
            set {
                if ((this.evidenceField != null)) {
                    if ((evidenceField.Equals(value) != true)) {
                        this.evidenceField = value;
                        this.OnPropertyChanged("Evidence");
                    }
                }
                else {
                    this.evidenceField = value;
        ...
        private static System.Xml.Serialization.XmlSerializer Serializer {
            get {
                if ((serializer == null)) {
                    serializer = new System.Xml.Serialization.XmlSerializer(typeof(TendererQualificationType));
                }
                return serializer;
            }
        }
        ...
        /// <summary>
        /// Serializes current TendererQualificationType object into an XML document
        /// </summary>
        ...
        /// <summary>
        /// Deserializes workflow markup into an TendererQualificationType object
        /// </summary>
        /// <param name="xml">string workflow markup to deserialize</param>
        /// <param name="obj">Output TendererQualificationType object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool Deserialize(string xml, out TendererQualificationType obj, out System.Exception exception) {
            exception = null;
            obj = default(TendererQualificationType);
            try {
                obj = Deserialize(xml);
                return true;
            }
        ...
        public static bool Deserialize(string xml, out TendererQualificationType obj) {
            System.Exception exception = null;
            return Deserialize(xml, out obj, out exception);
        }
        
        public static TendererQualificationType Deserialize(string xml) {
            System.IO.StringReader stringReader = null;
            try {
                stringReader = new System.IO.StringReader(xml);
                return ((TendererQualificationType)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally {
        ...
        /// <summary>
        /// Serializes current TendererQualificationType object into file
        /// </summary>
        ...
        /// <summary>
        /// Deserializes xml markup from file into an TendererQualificationType object
        /// </summary>
        /// <param name="fileName">string xml file to load and deserialize</param>
        /// <param name="obj">Output TendererQualificationType object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, out TendererQualificationType obj, out System.Exception exception) {
            exception = null;
            obj = default(TendererQualificationType);
            try {
        ...
        public static bool LoadFromFile(string fileName, out TendererQualificationType obj) {
            System.Exception exception = null;
            return LoadFromFile(fileName, out obj, out exception);
        }
        
        public static TendererQualificationType LoadFromFile(string fileName) {
        ...
        #region Clone method
        /// <summary>
        /// Create a clone of this TendererQualificationType object
        /// </summary>
        public virtual TendererQualificationType Clone() {
            return ((TendererQualificationType)(this.MemberwiseClone()));
        }
        #endregion
    }
}
