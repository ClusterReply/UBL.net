...
namespace Oasis.Ubl.v21 {
    ...
    public partial class ForwardingInstructionsType : System.ComponentModel.INotifyPropertyChanged {
        ...
        private static System.Xml.Serialization.XmlSerializer Serializer {
            get {
                if ((serializer == null)) {
                    serializer = new System.Xml.Serialization.XmlSerializer(typeof(ForwardingInstructionsType));
                }
                return serializer;
            }
        }
        ...
        /// <summary>
        /// Serializes current ForwardingInstructionsType object into an XML document
        /// </summary>
        ...
        /// <summary>
        /// Deserializes workflow markup into an ForwardingInstructionsType object
        /// </summary>
        /// <param name="xml">string workflow markup to deserialize</param>
        /// <param name="obj">Output ForwardingInstructionsType object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool Deserialize(string xml, out ForwardingInstructionsType obj, out System.Exception exception) {
            exception = null;
            obj = default(ForwardingInstructionsType);
            try {
                obj = Deserialize(xml);
                return true;
            }
        ...
        public static bool Deserialize(string xml, out ForwardingInstructionsType obj) {
            System.Exception exception = null;
            return Deserialize(xml, out obj, out exception);
        }
        
        public static ForwardingInstructionsType Deserialize(string xml) {
            System.IO.StringReader stringReader = null;
            try {
                stringReader = new System.IO.StringReader(xml);
                return ((ForwardingInstructionsType)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally {
        ...
        /// <summary>
        /// Serializes current ForwardingInstructionsType object into file
        /// </summary>
        ...
        /// <summary>
        /// Deserializes xml markup from file into an ForwardingInstructionsType object
        /// </summary>
        /// <param name="fileName">string xml file to load and deserialize</param>
        /// <param name="obj">Output ForwardingInstructionsType object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, out ForwardingInstructionsType obj, out System.Exception exception) {
            exception = null;
            obj = default(ForwardingInstructionsType);
            try {
        ...
        public static bool LoadFromFile(string fileName, out ForwardingInstructionsType obj) {
            System.Exception exception = null;
            return LoadFromFile(fileName, out obj, out exception);
        }
        
        public static ForwardingInstructionsType LoadFromFile(string fileName) {
        ...
        #region Clone method
        /// <summary>
        /// Create a clone of this ForwardingInstructionsType object
        /// </summary>
        public virtual ForwardingInstructionsType Clone() {
            return ((ForwardingInstructionsType)(this.MemberwiseClone()));
        }
        #endregion
    }
}
