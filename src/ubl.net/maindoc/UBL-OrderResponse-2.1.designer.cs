...
namespace Oasis.Ubl.v21 {
    ...
    public partial class OrderResponseType : System.ComponentModel.INotifyPropertyChanged {
        ...
        private ObservableCollection<DocumentReferenceType> orderDocumentReferenceField;
        ...
        public OrderResponseType() {
            ...
            this.netVolumeMeasureField = new NetVolumeMeasureType();
            this.grossVolumeMeasureField = new GrossVolumeMeasureType();
            this.netNetWeightMeasureField = new NetNetWeightMeasureType();
            this.netWeightMeasureField = new NetWeightMeasureType();
            this.grossWeightMeasureField = new GrossWeightMeasureType();
            this.totalPackagesQuantityField = new TotalPackagesQuantityType();
            ...
            this.orderResponseCodeField = new OrderResponseCodeType();
        ...
        public OrderResponseCodeType OrderResponseCode {
            ...
            set {
                if ((this.orderResponseCodeField != null)) {
                    if ((orderResponseCodeField.Equals(value) != true)) {
                        this.orderResponseCodeField = value;
                        this.OnPropertyChanged("OrderResponseCode");
                    }
                }
                else {
                    this.orderResponseCodeField = value;
        ...
        public TotalPackagesQuantityType TotalPackagesQuantity {
            ...
            set {
                if ((this.totalPackagesQuantityField != null)) {
                    if ((totalPackagesQuantityField.Equals(value) != true)) {
                        this.totalPackagesQuantityField = value;
                        this.OnPropertyChanged("TotalPackagesQuantity");
                    }
                }
                else {
                    this.totalPackagesQuantityField = value;
        ...
        public GrossWeightMeasureType GrossWeightMeasure {
            ...
            set {
                if ((this.grossWeightMeasureField != null)) {
                    if ((grossWeightMeasureField.Equals(value) != true)) {
                        this.grossWeightMeasureField = value;
                        this.OnPropertyChanged("GrossWeightMeasure");
                    }
                }
                else {
                    this.grossWeightMeasureField = value;
        ...
        public NetWeightMeasureType NetWeightMeasure {
            ...
            set {
                if ((this.netWeightMeasureField != null)) {
                    if ((netWeightMeasureField.Equals(value) != true)) {
                        this.netWeightMeasureField = value;
                        this.OnPropertyChanged("NetWeightMeasure");
                    }
                }
                else {
                    this.netWeightMeasureField = value;
        ...
        public NetNetWeightMeasureType NetNetWeightMeasure {
            ...
            set {
                if ((this.netNetWeightMeasureField != null)) {
                    if ((netNetWeightMeasureField.Equals(value) != true)) {
                        this.netNetWeightMeasureField = value;
                        this.OnPropertyChanged("NetNetWeightMeasure");
                    }
                }
                else {
                    this.netNetWeightMeasureField = value;
        ...
        public GrossVolumeMeasureType GrossVolumeMeasure {
            ...
            set {
                if ((this.grossVolumeMeasureField != null)) {
                    if ((grossVolumeMeasureField.Equals(value) != true)) {
                        this.grossVolumeMeasureField = value;
                        this.OnPropertyChanged("GrossVolumeMeasure");
                    }
                }
                else {
                    this.grossVolumeMeasureField = value;
        ...
        public NetVolumeMeasureType NetVolumeMeasure {
            ...
            set {
                if ((this.netVolumeMeasureField != null)) {
                    if ((netVolumeMeasureField.Equals(value) != true)) {
                        this.netVolumeMeasureField = value;
                        this.OnPropertyChanged("NetVolumeMeasure");
                    }
                }
                else {
                    this.netVolumeMeasureField = value;
        ...
        public ObservableCollection<DocumentReferenceType> OrderDocumentReference {
            ...
            set {
                if ((this.orderDocumentReferenceField != null)) {
                    if ((orderDocumentReferenceField.Equals(value) != true)) {
                        this.orderDocumentReferenceField = value;
                        this.OnPropertyChanged("OrderDocumentReference");
                    }
                }
                else {
                    this.orderDocumentReferenceField = value;
        ...
        private static System.Xml.Serialization.XmlSerializer Serializer {
            get {
                if ((serializer == null)) {
                    serializer = new System.Xml.Serialization.XmlSerializer(typeof(OrderResponseType));
                }
                return serializer;
            }
        }
        ...
        /// <summary>
        /// Serializes current OrderResponseType object into an XML document
        /// </summary>
        ...
        /// <summary>
        /// Deserializes workflow markup into an OrderResponseType object
        /// </summary>
        /// <param name="xml">string workflow markup to deserialize</param>
        /// <param name="obj">Output OrderResponseType object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool Deserialize(string xml, out OrderResponseType obj, out System.Exception exception) {
            exception = null;
            obj = default(OrderResponseType);
            try {
                obj = Deserialize(xml);
                return true;
            }
        ...
        public static bool Deserialize(string xml, out OrderResponseType obj) {
            System.Exception exception = null;
            return Deserialize(xml, out obj, out exception);
        }
        
        public static OrderResponseType Deserialize(string xml) {
            System.IO.StringReader stringReader = null;
            try {
                stringReader = new System.IO.StringReader(xml);
                return ((OrderResponseType)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally {
        ...
        /// <summary>
        /// Serializes current OrderResponseType object into file
        /// </summary>
        ...
        /// <summary>
        /// Deserializes xml markup from file into an OrderResponseType object
        /// </summary>
        /// <param name="fileName">string xml file to load and deserialize</param>
        /// <param name="obj">Output OrderResponseType object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, out OrderResponseType obj, out System.Exception exception) {
            exception = null;
            obj = default(OrderResponseType);
            try {
        ...
        public static bool LoadFromFile(string fileName, out OrderResponseType obj) {
            System.Exception exception = null;
            return LoadFromFile(fileName, out obj, out exception);
        }
        
        public static OrderResponseType LoadFromFile(string fileName) {
        ...
        #region Clone method
        /// <summary>
        /// Create a clone of this OrderResponseType object
        /// </summary>
        public virtual OrderResponseType Clone() {
            return ((OrderResponseType)(this.MemberwiseClone()));
        }
        #endregion
    }
}
