...
namespace Oasis.Ubl.v21 {
    ...
    public partial class ReceiptAdviceType : System.ComponentModel.INotifyPropertyChanged {
        ...
        private ObservableCollection<ReceiptLineType> receiptLineField;
        ...
        public ReceiptAdviceTypeCodeType ReceiptAdviceTypeCode {
            ...
            set {
                if ((this.receiptAdviceTypeCodeField != null)) {
                    if ((receiptAdviceTypeCodeField.Equals(value) != true)) {
                        this.receiptAdviceTypeCodeField = value;
                        this.OnPropertyChanged("ReceiptAdviceTypeCode");
                    }
                }
                else {
                    this.receiptAdviceTypeCodeField = value;
        ...
        public ObservableCollection<ReceiptLineType> ReceiptLine {
            get {
                return this.receiptLineField;
            }
            set {
                if ((this.receiptLineField != null)) {
                    if ((receiptLineField.Equals(value) != true)) {
                        this.receiptLineField = value;
                        this.OnPropertyChanged("ReceiptLine");
                    }
                }
                else {
                    this.receiptLineField = value;
        ...
        private static System.Xml.Serialization.XmlSerializer Serializer {
            get {
                if ((serializer == null)) {
                    serializer = new System.Xml.Serialization.XmlSerializer(typeof(ReceiptAdviceType));
                }
                return serializer;
            }
        }
        ...
        /// <summary>
        /// Serializes current ReceiptAdviceType object into an XML document
        /// </summary>
        ...
        /// <summary>
        /// Deserializes workflow markup into an ReceiptAdviceType object
        /// </summary>
        /// <param name="xml">string workflow markup to deserialize</param>
        /// <param name="obj">Output ReceiptAdviceType object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool Deserialize(string xml, out ReceiptAdviceType obj, out System.Exception exception) {
            exception = null;
            obj = default(ReceiptAdviceType);
            try {
                obj = Deserialize(xml);
                return true;
            }
        ...
        public static bool Deserialize(string xml, out ReceiptAdviceType obj) {
            System.Exception exception = null;
            return Deserialize(xml, out obj, out exception);
        }
        
        public static ReceiptAdviceType Deserialize(string xml) {
            System.IO.StringReader stringReader = null;
            try {
                stringReader = new System.IO.StringReader(xml);
                return ((ReceiptAdviceType)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally {
        ...
        /// <summary>
        /// Serializes current ReceiptAdviceType object into file
        /// </summary>
        ...
        /// <summary>
        /// Deserializes xml markup from file into an ReceiptAdviceType object
        /// </summary>
        /// <param name="fileName">string xml file to load and deserialize</param>
        /// <param name="obj">Output ReceiptAdviceType object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, out ReceiptAdviceType obj, out System.Exception exception) {
            exception = null;
            obj = default(ReceiptAdviceType);
            try {
        ...
        public static bool LoadFromFile(string fileName, out ReceiptAdviceType obj) {
            System.Exception exception = null;
            return LoadFromFile(fileName, out obj, out exception);
        }
        
        public static ReceiptAdviceType LoadFromFile(string fileName) {
        ...
        #region Clone method
        /// <summary>
        /// Create a clone of this ReceiptAdviceType object
        /// </summary>
        public virtual ReceiptAdviceType Clone() {
            return ((ReceiptAdviceType)(this.MemberwiseClone()));
        }
        #endregion
    }
}
