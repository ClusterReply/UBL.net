...
namespace Oasis.Ubl.v21 {
    ...
    public partial class RetailEventType : System.ComponentModel.INotifyPropertyChanged {
        ...
        private ObservableCollection<EventCommentType> eventCommentField;
        ...
        public RetailEventNameType RetailEventName {
            ...
            set {
                if ((this.retailEventNameField != null)) {
                    if ((retailEventNameField.Equals(value) != true)) {
                        this.retailEventNameField = value;
                        this.OnPropertyChanged("RetailEventName");
                    }
                }
                else {
                    this.retailEventNameField = value;
        ...
        public RetailEventStatusCodeType RetailEventStatusCode {
            ...
            set {
                if ((this.retailEventStatusCodeField != null)) {
                    if ((retailEventStatusCodeField.Equals(value) != true)) {
                        this.retailEventStatusCodeField = value;
                        this.OnPropertyChanged("RetailEventStatusCode");
                    }
                }
                else {
                    this.retailEventStatusCodeField = value;
        ...
        public SellerEventIDType SellerEventID {
            ...
            set {
                if ((this.sellerEventIDField != null)) {
                    if ((sellerEventIDField.Equals(value) != true)) {
                        this.sellerEventIDField = value;
                        this.OnPropertyChanged("SellerEventID");
                    }
                }
                else {
                    this.sellerEventIDField = value;
        ...
        public BuyerEventIDType BuyerEventID {
            ...
            set {
                if ((this.buyerEventIDField != null)) {
                    if ((buyerEventIDField.Equals(value) != true)) {
                        this.buyerEventIDField = value;
                        this.OnPropertyChanged("BuyerEventID");
                    }
                }
                else {
                    this.buyerEventIDField = value;
        ...
        public ObservableCollection<EventCommentType> EventComment {
            get {
                return this.eventCommentField;
            }
            set {
                if ((this.eventCommentField != null)) {
                    if ((eventCommentField.Equals(value) != true)) {
                        this.eventCommentField = value;
                        this.OnPropertyChanged("EventComment");
                    }
                }
                else {
                    this.eventCommentField = value;
        ...
        public PromotionalEventType PromotionalEvent {
            ...
            set {
                if ((this.promotionalEventField != null)) {
                    if ((promotionalEventField.Equals(value) != true)) {
                        this.promotionalEventField = value;
                        this.OnPropertyChanged("PromotionalEvent");
                    }
                }
                else {
                    this.promotionalEventField = value;
        ...
        public MiscellaneousEventType MiscellaneousEvent {
            ...
            set {
                if ((this.miscellaneousEventField != null)) {
                    if ((miscellaneousEventField.Equals(value) != true)) {
                        this.miscellaneousEventField = value;
                        this.OnPropertyChanged("MiscellaneousEvent");
                    }
                }
                else {
                    this.miscellaneousEventField = value;
        ...
        private static System.Xml.Serialization.XmlSerializer Serializer {
            get {
                if ((serializer == null)) {
                    serializer = new System.Xml.Serialization.XmlSerializer(typeof(RetailEventType));
                }
                return serializer;
            }
        }
        ...
        /// <summary>
        /// Serializes current RetailEventType object into an XML document
        /// </summary>
        ...
        /// <summary>
        /// Deserializes workflow markup into an RetailEventType object
        /// </summary>
        /// <param name="xml">string workflow markup to deserialize</param>
        /// <param name="obj">Output RetailEventType object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool Deserialize(string xml, out RetailEventType obj, out System.Exception exception) {
            exception = null;
            obj = default(RetailEventType);
            try {
                obj = Deserialize(xml);
                return true;
            }
        ...
        public static bool Deserialize(string xml, out RetailEventType obj) {
            System.Exception exception = null;
            return Deserialize(xml, out obj, out exception);
        }
        
        public static RetailEventType Deserialize(string xml) {
            System.IO.StringReader stringReader = null;
            try {
                stringReader = new System.IO.StringReader(xml);
                return ((RetailEventType)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally {
        ...
        /// <summary>
        /// Serializes current RetailEventType object into file
        /// </summary>
        ...
        /// <summary>
        /// Deserializes xml markup from file into an RetailEventType object
        /// </summary>
        /// <param name="fileName">string xml file to load and deserialize</param>
        /// <param name="obj">Output RetailEventType object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, out RetailEventType obj, out System.Exception exception) {
            exception = null;
            obj = default(RetailEventType);
            try {
        ...
        public static bool LoadFromFile(string fileName, out RetailEventType obj) {
            System.Exception exception = null;
            return LoadFromFile(fileName, out obj, out exception);
        }
        
        public static RetailEventType LoadFromFile(string fileName) {
        ...
        #region Clone method
        /// <summary>
        /// Create a clone of this RetailEventType object
        /// </summary>
        public virtual RetailEventType Clone() {
            return ((RetailEventType)(this.MemberwiseClone()));
        }
        #endregion
    }
}
