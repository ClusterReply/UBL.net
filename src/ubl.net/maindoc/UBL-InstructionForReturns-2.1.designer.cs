...
namespace Oasis.Ubl.v21 {
    ...
    public partial class InstructionForReturnsType : System.ComponentModel.INotifyPropertyChanged {
        ...
        private ObservableCollection<InstructionForReturnsLineType> instructionForReturnsLineField;
        ...
        public PartyType ManufacturerParty {
            ...
            set {
                if ((this.manufacturerPartyField != null)) {
                    if ((manufacturerPartyField.Equals(value) != true)) {
                        this.manufacturerPartyField = value;
                        this.OnPropertyChanged("ManufacturerParty");
                    }
                }
                else {
                    this.manufacturerPartyField = value;
        ...
        public ObservableCollection<InstructionForReturnsLineType> InstructionForReturnsLine {
            get {
                return this.instructionForReturnsLineField;
            }
            set {
                if ((this.instructionForReturnsLineField != null)) {
                    if ((instructionForReturnsLineField.Equals(value) != true)) {
                        this.instructionForReturnsLineField = value;
                        this.OnPropertyChanged("InstructionForReturnsLine");
                    }
                }
                else {
                    this.instructionForReturnsLineField = value;
        ...
        private static System.Xml.Serialization.XmlSerializer Serializer {
            get {
                if ((serializer == null)) {
                    serializer = new System.Xml.Serialization.XmlSerializer(typeof(InstructionForReturnsType));
                }
                return serializer;
            }
        }
        ...
        /// <summary>
        /// Serializes current InstructionForReturnsType object into an XML document
        /// </summary>
        ...
        /// <summary>
        /// Deserializes workflow markup into an InstructionForReturnsType object
        /// </summary>
        /// <param name="xml">string workflow markup to deserialize</param>
        /// <param name="obj">Output InstructionForReturnsType object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool Deserialize(string xml, out InstructionForReturnsType obj, out System.Exception exception) {
            exception = null;
            obj = default(InstructionForReturnsType);
            try {
                obj = Deserialize(xml);
                return true;
            }
        ...
        public static bool Deserialize(string xml, out InstructionForReturnsType obj) {
            System.Exception exception = null;
            return Deserialize(xml, out obj, out exception);
        }
        
        public static InstructionForReturnsType Deserialize(string xml) {
            System.IO.StringReader stringReader = null;
            try {
                stringReader = new System.IO.StringReader(xml);
                return ((InstructionForReturnsType)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally {
        ...
        /// <summary>
        /// Serializes current InstructionForReturnsType object into file
        /// </summary>
        ...
        /// <summary>
        /// Deserializes xml markup from file into an InstructionForReturnsType object
        /// </summary>
        /// <param name="fileName">string xml file to load and deserialize</param>
        /// <param name="obj">Output InstructionForReturnsType object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, out InstructionForReturnsType obj, out System.Exception exception) {
            exception = null;
            obj = default(InstructionForReturnsType);
            try {
        ...
        public static bool LoadFromFile(string fileName, out InstructionForReturnsType obj) {
            System.Exception exception = null;
            return LoadFromFile(fileName, out obj, out exception);
        }
        
        public static InstructionForReturnsType LoadFromFile(string fileName) {
        ...
        #region Clone method
        /// <summary>
        /// Create a clone of this InstructionForReturnsType object
        /// </summary>
        public virtual InstructionForReturnsType Clone() {
            return ((InstructionForReturnsType)(this.MemberwiseClone()));
        }
        #endregion
    }
}
