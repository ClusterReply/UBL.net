...
namespace Oasis.Ubl.v21 {
    ...
    public partial class RequestForQuotationType : System.ComponentModel.INotifyPropertyChanged {
        ...
        private ObservableCollection<RequestForQuotationLineType> requestForQuotationLineField;
        ...
        public SubmissionDueDateType SubmissionDueDate {
            ...
            set {
                if ((this.submissionDueDateField != null)) {
                    if ((submissionDueDateField.Equals(value) != true)) {
                        this.submissionDueDateField = value;
                        this.OnPropertyChanged("SubmissionDueDate");
                    }
                }
                else {
                    this.submissionDueDateField = value;
        ...
        public PeriodType RequestedValidityPeriod {
            ...
            set {
                if ((this.requestedValidityPeriodField != null)) {
                    if ((requestedValidityPeriodField.Equals(value) != true)) {
                        this.requestedValidityPeriodField = value;
                        this.OnPropertyChanged("RequestedValidityPeriod");
                    }
                }
                else {
                    this.requestedValidityPeriodField = value;
        ...
        public DocumentReferenceType CatalogueDocumentReference {
            ...
            set {
                if ((this.catalogueDocumentReferenceField != null)) {
                    if ((catalogueDocumentReferenceField.Equals(value) != true)) {
                        this.catalogueDocumentReferenceField = value;
                        this.OnPropertyChanged("CatalogueDocumentReference");
                    }
                }
                else {
                    this.catalogueDocumentReferenceField = value;
        ...
        public ObservableCollection<RequestForQuotationLineType> RequestForQuotationLine {
            get {
                return this.requestForQuotationLineField;
            }
            set {
                if ((this.requestForQuotationLineField != null)) {
                    if ((requestForQuotationLineField.Equals(value) != true)) {
                        this.requestForQuotationLineField = value;
                        this.OnPropertyChanged("RequestForQuotationLine");
                    }
                }
                else {
                    this.requestForQuotationLineField = value;
        ...
        private static System.Xml.Serialization.XmlSerializer Serializer {
            get {
                if ((serializer == null)) {
                    serializer = new System.Xml.Serialization.XmlSerializer(typeof(RequestForQuotationType));
                }
                return serializer;
            }
        }
        ...
        /// <summary>
        /// Serializes current RequestForQuotationType object into an XML document
        /// </summary>
        ...
        /// <summary>
        /// Deserializes workflow markup into an RequestForQuotationType object
        /// </summary>
        /// <param name="xml">string workflow markup to deserialize</param>
        /// <param name="obj">Output RequestForQuotationType object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool Deserialize(string xml, out RequestForQuotationType obj, out System.Exception exception) {
            exception = null;
            obj = default(RequestForQuotationType);
            try {
                obj = Deserialize(xml);
                return true;
            }
        ...
        public static bool Deserialize(string xml, out RequestForQuotationType obj) {
            System.Exception exception = null;
            return Deserialize(xml, out obj, out exception);
        }
        
        public static RequestForQuotationType Deserialize(string xml) {
            System.IO.StringReader stringReader = null;
            try {
                stringReader = new System.IO.StringReader(xml);
                return ((RequestForQuotationType)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally {
        ...
        /// <summary>
        /// Serializes current RequestForQuotationType object into file
        /// </summary>
        ...
        /// <summary>
        /// Deserializes xml markup from file into an RequestForQuotationType object
        /// </summary>
        /// <param name="fileName">string xml file to load and deserialize</param>
        /// <param name="obj">Output RequestForQuotationType object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, out RequestForQuotationType obj, out System.Exception exception) {
            exception = null;
            obj = default(RequestForQuotationType);
            try {
        ...
        public static bool LoadFromFile(string fileName, out RequestForQuotationType obj) {
            System.Exception exception = null;
            return LoadFromFile(fileName, out obj, out exception);
        }
        
        public static RequestForQuotationType LoadFromFile(string fileName) {
        ...
        #region Clone method
        /// <summary>
        /// Create a clone of this RequestForQuotationType object
        /// </summary>
        public virtual RequestForQuotationType Clone() {
            return ((RequestForQuotationType)(this.MemberwiseClone()));
        }
        #endregion
    }
}
