...
namespace Oasis.Ubl.v21 {
    ...
    public partial class DespatchAdviceType : System.ComponentModel.INotifyPropertyChanged {
        ...
        private ObservableCollection<DespatchLineType> despatchLineField;
        
        private static System.Xml.Serialization.XmlSerializer serializer;
        
        public DespatchAdviceType() {
            this.despatchLineField = new ObservableCollection<DespatchLineType>();
            ...
            this.despatchAdviceTypeCodeField = new DespatchAdviceTypeCodeType();
        ...
        public DespatchAdviceTypeCodeType DespatchAdviceTypeCode {
            ...
            set {
                if ((this.despatchAdviceTypeCodeField != null)) {
                    if ((despatchAdviceTypeCodeField.Equals(value) != true)) {
                        this.despatchAdviceTypeCodeField = value;
                        this.OnPropertyChanged("DespatchAdviceTypeCode");
                    }
                }
                else {
                    this.despatchAdviceTypeCodeField = value;
        ...
        public ObservableCollection<DespatchLineType> DespatchLine {
            get {
                return this.despatchLineField;
            }
            set {
                if ((this.despatchLineField != null)) {
                    if ((despatchLineField.Equals(value) != true)) {
                        this.despatchLineField = value;
                        this.OnPropertyChanged("DespatchLine");
                    }
                }
                else {
                    this.despatchLineField = value;
        ...
        private static System.Xml.Serialization.XmlSerializer Serializer {
            get {
                if ((serializer == null)) {
                    serializer = new System.Xml.Serialization.XmlSerializer(typeof(DespatchAdviceType));
                }
                return serializer;
            }
        }
        ...
        /// <summary>
        /// Serializes current DespatchAdviceType object into an XML document
        /// </summary>
        ...
        /// <summary>
        /// Deserializes workflow markup into an DespatchAdviceType object
        /// </summary>
        /// <param name="xml">string workflow markup to deserialize</param>
        /// <param name="obj">Output DespatchAdviceType object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool Deserialize(string xml, out DespatchAdviceType obj, out System.Exception exception) {
            exception = null;
            obj = default(DespatchAdviceType);
            try {
                obj = Deserialize(xml);
                return true;
            }
        ...
        public static bool Deserialize(string xml, out DespatchAdviceType obj) {
            System.Exception exception = null;
            return Deserialize(xml, out obj, out exception);
        }
        
        public static DespatchAdviceType Deserialize(string xml) {
            System.IO.StringReader stringReader = null;
            try {
                stringReader = new System.IO.StringReader(xml);
                return ((DespatchAdviceType)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally {
        ...
        /// <summary>
        /// Serializes current DespatchAdviceType object into file
        /// </summary>
        ...
        /// <summary>
        /// Deserializes xml markup from file into an DespatchAdviceType object
        /// </summary>
        /// <param name="fileName">string xml file to load and deserialize</param>
        /// <param name="obj">Output DespatchAdviceType object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, out DespatchAdviceType obj, out System.Exception exception) {
            exception = null;
            obj = default(DespatchAdviceType);
            try {
        ...
        public static bool LoadFromFile(string fileName, out DespatchAdviceType obj) {
            System.Exception exception = null;
            return LoadFromFile(fileName, out obj, out exception);
        }
        
        public static DespatchAdviceType LoadFromFile(string fileName) {
        ...
        #region Clone method
        /// <summary>
        /// Create a clone of this DespatchAdviceType object
        /// </summary>
        public virtual DespatchAdviceType Clone() {
            return ((DespatchAdviceType)(this.MemberwiseClone()));
        }
        #endregion
    }
}
