...
namespace Oasis.Ubl.v21 {
    ...
    public partial class TendererQualificationResponseType : System.ComponentModel.INotifyPropertyChanged {
        ...
        private ObservableCollection<QualificationResolutionType> qualificationResolutionField;
        ...
        public DocumentReferenceType ResolutionDocumentReference {
            ...
            set {
                if ((this.resolutionDocumentReferenceField != null)) {
                    if ((resolutionDocumentReferenceField.Equals(value) != true)) {
                        this.resolutionDocumentReferenceField = value;
                        this.OnPropertyChanged("ResolutionDocumentReference");
                    }
                }
                else {
                    this.resolutionDocumentReferenceField = value;
        ...
        public ObservableCollection<QualificationResolutionType> QualificationResolution {
            get {
                return this.qualificationResolutionField;
            }
            set {
                if ((this.qualificationResolutionField != null)) {
                    if ((qualificationResolutionField.Equals(value) != true)) {
                        this.qualificationResolutionField = value;
                        this.OnPropertyChanged("QualificationResolution");
                    }
                }
                else {
                    this.qualificationResolutionField = value;
        ...
        private static System.Xml.Serialization.XmlSerializer Serializer {
            get {
                if ((serializer == null)) {
                    serializer = new System.Xml.Serialization.XmlSerializer(typeof(TendererQualificationResponseType));
                }
                return serializer;
            }
        }
        ...
        /// <summary>
        /// Serializes current TendererQualificationResponseType object into an XML document
        /// </summary>
        ...
        /// <summary>
        /// Deserializes workflow markup into an TendererQualificationResponseType object
        /// </summary>
        /// <param name="xml">string workflow markup to deserialize</param>
        /// <param name="obj">Output TendererQualificationResponseType object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool Deserialize(string xml, out TendererQualificationResponseType obj, out System.Exception exception) {
            exception = null;
            obj = default(TendererQualificationResponseType);
            try {
                obj = Deserialize(xml);
                return true;
            }
        ...
        public static bool Deserialize(string xml, out TendererQualificationResponseType obj) {
            System.Exception exception = null;
            return Deserialize(xml, out obj, out exception);
        }
        
        public static TendererQualificationResponseType Deserialize(string xml) {
            System.IO.StringReader stringReader = null;
            try {
                stringReader = new System.IO.StringReader(xml);
                return ((TendererQualificationResponseType)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally {
        ...
        /// <summary>
        /// Serializes current TendererQualificationResponseType object into file
        /// </summary>
        ...
        /// <summary>
        /// Deserializes xml markup from file into an TendererQualificationResponseType object
        /// </summary>
        /// <param name="fileName">string xml file to load and deserialize</param>
        /// <param name="obj">Output TendererQualificationResponseType object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, out TendererQualificationResponseType obj, out System.Exception exception) {
            exception = null;
            obj = default(TendererQualificationResponseType);
            try {
        ...
        public static bool LoadFromFile(string fileName, out TendererQualificationResponseType obj) {
            System.Exception exception = null;
            return LoadFromFile(fileName, out obj, out exception);
        }
        
        public static TendererQualificationResponseType LoadFromFile(string fileName) {
        ...
        #region Clone method
        /// <summary>
        /// Create a clone of this TendererQualificationResponseType object
        /// </summary>
        public virtual TendererQualificationResponseType Clone() {
            return ((TendererQualificationResponseType)(this.MemberwiseClone()));
        }
        #endregion
    }
}
