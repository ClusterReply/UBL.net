...
namespace Oasis.Ubl.v21 {
    ...
    public partial class PriorInformationNoticeType : System.ComponentModel.INotifyPropertyChanged {
        ...
        public PlannedDateType PlannedDate {
            ...
            set {
                if ((this.plannedDateField != null)) {
                    if ((plannedDateField.Equals(value) != true)) {
        ...
        private static System.Xml.Serialization.XmlSerializer Serializer {
            get {
                if ((serializer == null)) {
                    serializer = new System.Xml.Serialization.XmlSerializer(typeof(PriorInformationNoticeType));
                }
                return serializer;
            }
        }
        ...
        /// <summary>
        /// Serializes current PriorInformationNoticeType object into an XML document
        /// </summary>
        ...
        /// <summary>
        /// Deserializes workflow markup into an PriorInformationNoticeType object
        /// </summary>
        /// <param name="xml">string workflow markup to deserialize</param>
        /// <param name="obj">Output PriorInformationNoticeType object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool Deserialize(string xml, out PriorInformationNoticeType obj, out System.Exception exception) {
            exception = null;
            obj = default(PriorInformationNoticeType);
            try {
                obj = Deserialize(xml);
                return true;
            }
        ...
        public static bool Deserialize(string xml, out PriorInformationNoticeType obj) {
            System.Exception exception = null;
            return Deserialize(xml, out obj, out exception);
        }
        
        public static PriorInformationNoticeType Deserialize(string xml) {
            System.IO.StringReader stringReader = null;
            try {
                stringReader = new System.IO.StringReader(xml);
                return ((PriorInformationNoticeType)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally {
        ...
        /// <summary>
        /// Serializes current PriorInformationNoticeType object into file
        /// </summary>
        ...
        /// <summary>
        /// Deserializes xml markup from file into an PriorInformationNoticeType object
        /// </summary>
        /// <param name="fileName">string xml file to load and deserialize</param>
        /// <param name="obj">Output PriorInformationNoticeType object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, out PriorInformationNoticeType obj, out System.Exception exception) {
            exception = null;
            obj = default(PriorInformationNoticeType);
            try {
        ...
        public static bool LoadFromFile(string fileName, out PriorInformationNoticeType obj) {
            System.Exception exception = null;
            return LoadFromFile(fileName, out obj, out exception);
        }
        
        public static PriorInformationNoticeType LoadFromFile(string fileName) {
        ...
        #region Clone method
        /// <summary>
        /// Create a clone of this PriorInformationNoticeType object
        /// </summary>
        public virtual PriorInformationNoticeType Clone() {
            return ((PriorInformationNoticeType)(this.MemberwiseClone()));
        }
        #endregion
    }
}
