...
namespace Oasis.Ubl.v21 {
    ...
    public partial class ApplicationResponseType : System.ComponentModel.INotifyPropertyChanged {
        ...
        private ObservableCollection<DocumentResponseType> documentResponseField;
        ...
        public ApplicationResponseType() {
            ...
            this.responseTimeField = new ResponseTimeType();
            this.responseDateField = new ResponseDateType();
        ...
        public ResponseDateType ResponseDate {
            ...
            set {
                if ((this.responseDateField != null)) {
                    if ((responseDateField.Equals(value) != true)) {
        ...
        #region Clone method
        /// <summary>
        /// Create a clone of this ApplicationResponseType object
        /// </summary>
        public virtual ApplicationResponseType Clone() {
            return ((ApplicationResponseType)(this.MemberwiseClone()));
        }
        #endregion
    }
}
