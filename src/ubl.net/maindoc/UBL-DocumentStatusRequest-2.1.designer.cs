...
namespace Oasis.Ubl.v21 {
    ...
    public partial class DocumentStatusRequestType : System.ComponentModel.INotifyPropertyChanged {
        ...
        public TrackingIDType TrackingID {
            ...
            set {
                if ((this.trackingIDField != null)) {
                    if ((trackingIDField.Equals(value) != true)) {
        ...
        public DocumentReferenceType RequestedDocumentReference {
            ...
            set {
                if ((this.requestedDocumentReferenceField != null)) {
                    if ((requestedDocumentReferenceField.Equals(value) != true)) {
                        this.requestedDocumentReferenceField = value;
                        this.OnPropertyChanged("RequestedDocumentReference");
                    }
                }
                else {
                    this.requestedDocumentReferenceField = value;
        ...
        private static System.Xml.Serialization.XmlSerializer Serializer {
            get {
                if ((serializer == null)) {
                    serializer = new System.Xml.Serialization.XmlSerializer(typeof(DocumentStatusRequestType));
                }
                return serializer;
            }
        }
        ...
        /// <summary>
        /// Serializes current DocumentStatusRequestType object into an XML document
        /// </summary>
        ...
        /// <summary>
        /// Deserializes workflow markup into an DocumentStatusRequestType object
        /// </summary>
        /// <param name="xml">string workflow markup to deserialize</param>
        /// <param name="obj">Output DocumentStatusRequestType object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool Deserialize(string xml, out DocumentStatusRequestType obj, out System.Exception exception) {
            exception = null;
            obj = default(DocumentStatusRequestType);
            try {
                obj = Deserialize(xml);
                return true;
            }
        ...
        public static bool Deserialize(string xml, out DocumentStatusRequestType obj) {
            System.Exception exception = null;
            return Deserialize(xml, out obj, out exception);
        }
        
        public static DocumentStatusRequestType Deserialize(string xml) {
            System.IO.StringReader stringReader = null;
            try {
                stringReader = new System.IO.StringReader(xml);
                return ((DocumentStatusRequestType)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally {
        ...
        /// <summary>
        /// Serializes current DocumentStatusRequestType object into file
        /// </summary>
        ...
        /// <summary>
        /// Deserializes xml markup from file into an DocumentStatusRequestType object
        /// </summary>
        /// <param name="fileName">string xml file to load and deserialize</param>
        /// <param name="obj">Output DocumentStatusRequestType object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, out DocumentStatusRequestType obj, out System.Exception exception) {
            exception = null;
            obj = default(DocumentStatusRequestType);
            try {
        ...
        public static bool LoadFromFile(string fileName, out DocumentStatusRequestType obj) {
            System.Exception exception = null;
            return LoadFromFile(fileName, out obj, out exception);
        }
        
        public static DocumentStatusRequestType LoadFromFile(string fileName) {
        ...
        #region Clone method
        /// <summary>
        /// Create a clone of this DocumentStatusRequestType object
        /// </summary>
        public virtual DocumentStatusRequestType Clone() {
            return ((DocumentStatusRequestType)(this.MemberwiseClone()));
        }
        #endregion
    }
}
