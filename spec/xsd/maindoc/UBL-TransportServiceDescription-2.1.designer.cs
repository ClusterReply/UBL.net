...
namespace Oasis.Ubl.v21 {
    ...
    public partial class TransportServiceDescriptionType : System.ComponentModel.INotifyPropertyChanged {
        ...
        private DocumentReferenceType transportServiceDescriptionRequestDocumentReferenceField;
        ...
        public ResponseCodeType ResponseCode {
            ...
            set {
                if ((this.responseCodeField != null)) {
                    if ((responseCodeField.Equals(value) != true)) {
        ...
        public DocumentReferenceType TransportServiceDescriptionRequestDocumentReference {
            get {
                return this.transportServiceDescriptionRequestDocumentReferenceField;
            }
            set {
                if ((this.transportServiceDescriptionRequestDocumentReferenceField != null)) {
                    if ((transportServiceDescriptionRequestDocumentReferenceField.Equals(value) != true)) {
                        this.transportServiceDescriptionRequestDocumentReferenceField = value;
                        this.OnPropertyChanged("TransportServiceDescriptionRequestDocumentReference");
                    }
                }
                else {
                    this.transportServiceDescriptionRequestDocumentReferenceField = value;
        ...
        public PaymentTermsType ServiceChargePaymentTerms {
            ...
            set {
                if ((this.serviceChargePaymentTermsField != null)) {
                    if ((serviceChargePaymentTermsField.Equals(value) != true)) {
                        this.serviceChargePaymentTermsField = value;
                        this.OnPropertyChanged("ServiceChargePaymentTerms");
                    }
                }
                else {
                    this.serviceChargePaymentTermsField = value;
        ...
        private static System.Xml.Serialization.XmlSerializer Serializer {
            get {
                if ((serializer == null)) {
                    serializer = new System.Xml.Serialization.XmlSerializer(typeof(TransportServiceDescriptionType));
                }
                return serializer;
            }
        }
        ...
        /// <summary>
        /// Serializes current TransportServiceDescriptionType object into an XML document
        /// </summary>
        ...
        /// <summary>
        /// Deserializes workflow markup into an TransportServiceDescriptionType object
        /// </summary>
        /// <param name="xml">string workflow markup to deserialize</param>
        /// <param name="obj">Output TransportServiceDescriptionType object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool Deserialize(string xml, out TransportServiceDescriptionType obj, out System.Exception exception) {
            exception = null;
            obj = default(TransportServiceDescriptionType);
            try {
                obj = Deserialize(xml);
                return true;
            }
        ...
        public static bool Deserialize(string xml, out TransportServiceDescriptionType obj) {
            System.Exception exception = null;
            return Deserialize(xml, out obj, out exception);
        }
        
        public static TransportServiceDescriptionType Deserialize(string xml) {
            System.IO.StringReader stringReader = null;
            try {
                stringReader = new System.IO.StringReader(xml);
                return ((TransportServiceDescriptionType)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally {
        ...
        /// <summary>
        /// Serializes current TransportServiceDescriptionType object into file
        /// </summary>
        ...
        /// <summary>
        /// Deserializes xml markup from file into an TransportServiceDescriptionType object
        /// </summary>
        /// <param name="fileName">string xml file to load and deserialize</param>
        /// <param name="obj">Output TransportServiceDescriptionType object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, out TransportServiceDescriptionType obj, out System.Exception exception) {
            exception = null;
            obj = default(TransportServiceDescriptionType);
            try {
        ...
        public static bool LoadFromFile(string fileName, out TransportServiceDescriptionType obj) {
            System.Exception exception = null;
            return LoadFromFile(fileName, out obj, out exception);
        }
        
        public static TransportServiceDescriptionType LoadFromFile(string fileName) {
        ...
        #region Clone method
        /// <summary>
        /// Create a clone of this TransportServiceDescriptionType object
        /// </summary>
        public virtual TransportServiceDescriptionType Clone() {
            return ((TransportServiceDescriptionType)(this.MemberwiseClone()));
        }
        #endregion
    }
}
