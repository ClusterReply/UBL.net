...
namespace Oasis.Ubl.v21 {
    ...
    public partial class ProductActivityType : System.ComponentModel.INotifyPropertyChanged {
        ...
        private ObservableCollection<ActivityDataLineType> supplyChainActivityDataLineField;
        ...
        public PeriodType ActivityPeriod {
            ...
            set {
                if ((this.activityPeriodField != null)) {
                    if ((activityPeriodField.Equals(value) != true)) {
                        this.activityPeriodField = value;
                        this.OnPropertyChanged("ActivityPeriod");
                    }
                }
                else {
                    this.activityPeriodField = value;
        ...
        public ObservableCollection<ActivityDataLineType> SupplyChainActivityDataLine {
            get {
                return this.supplyChainActivityDataLineField;
            }
            set {
                if ((this.supplyChainActivityDataLineField != null)) {
                    if ((supplyChainActivityDataLineField.Equals(value) != true)) {
                        this.supplyChainActivityDataLineField = value;
                        this.OnPropertyChanged("SupplyChainActivityDataLine");
                    }
                }
                else {
                    this.supplyChainActivityDataLineField = value;
        ...
        private static System.Xml.Serialization.XmlSerializer Serializer {
            get {
                if ((serializer == null)) {
                    serializer = new System.Xml.Serialization.XmlSerializer(typeof(ProductActivityType));
                }
                return serializer;
            }
        }
        ...
        /// <summary>
        /// Serializes current ProductActivityType object into an XML document
        /// </summary>
        ...
        /// <summary>
        /// Deserializes workflow markup into an ProductActivityType object
        /// </summary>
        /// <param name="xml">string workflow markup to deserialize</param>
        /// <param name="obj">Output ProductActivityType object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool Deserialize(string xml, out ProductActivityType obj, out System.Exception exception) {
            exception = null;
            obj = default(ProductActivityType);
            try {
                obj = Deserialize(xml);
                return true;
            }
        ...
        public static bool Deserialize(string xml, out ProductActivityType obj) {
            System.Exception exception = null;
            return Deserialize(xml, out obj, out exception);
        }
        
        public static ProductActivityType Deserialize(string xml) {
            System.IO.StringReader stringReader = null;
            try {
                stringReader = new System.IO.StringReader(xml);
                return ((ProductActivityType)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally {
        ...
        /// <summary>
        /// Serializes current ProductActivityType object into file
        /// </summary>
        ...
        /// <summary>
        /// Deserializes xml markup from file into an ProductActivityType object
        /// </summary>
        /// <param name="fileName">string xml file to load and deserialize</param>
        /// <param name="obj">Output ProductActivityType object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, out ProductActivityType obj, out System.Exception exception) {
            exception = null;
            obj = default(ProductActivityType);
            try {
        ...
        public static bool LoadFromFile(string fileName, out ProductActivityType obj) {
            System.Exception exception = null;
            return LoadFromFile(fileName, out obj, out exception);
        }
        
        public static ProductActivityType LoadFromFile(string fileName) {
        ...
        #region Clone method
        /// <summary>
        /// Create a clone of this ProductActivityType object
        /// </summary>
        public virtual ProductActivityType Clone() {
            return ((ProductActivityType)(this.MemberwiseClone()));
        }
        #endregion
    }
}
