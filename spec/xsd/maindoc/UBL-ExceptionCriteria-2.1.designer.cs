...
namespace Oasis.Ubl.v21 {
    ...
    public partial class ExceptionCriteriaType : System.ComponentModel.INotifyPropertyChanged {
        ...
        private ObservableCollection<ExceptionCriteriaLineType> exceptionCriteriaLineField;
        
        private static System.Xml.Serialization.XmlSerializer serializer;
        
        public ExceptionCriteriaType() {
            this.exceptionCriteriaLineField = new ObservableCollection<ExceptionCriteriaLineType>();
        ...
        public ObservableCollection<ExceptionCriteriaLineType> ExceptionCriteriaLine {
            get {
                return this.exceptionCriteriaLineField;
            }
            set {
                if ((this.exceptionCriteriaLineField != null)) {
                    if ((exceptionCriteriaLineField.Equals(value) != true)) {
                        this.exceptionCriteriaLineField = value;
                        this.OnPropertyChanged("ExceptionCriteriaLine");
                    }
                }
                else {
                    this.exceptionCriteriaLineField = value;
        ...
        private static System.Xml.Serialization.XmlSerializer Serializer {
            get {
                if ((serializer == null)) {
                    serializer = new System.Xml.Serialization.XmlSerializer(typeof(ExceptionCriteriaType));
                }
                return serializer;
            }
        }
        ...
        /// <summary>
        /// Serializes current ExceptionCriteriaType object into an XML document
        /// </summary>
        ...
        /// <summary>
        /// Deserializes workflow markup into an ExceptionCriteriaType object
        /// </summary>
        /// <param name="xml">string workflow markup to deserialize</param>
        /// <param name="obj">Output ExceptionCriteriaType object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool Deserialize(string xml, out ExceptionCriteriaType obj, out System.Exception exception) {
            exception = null;
            obj = default(ExceptionCriteriaType);
            try {
                obj = Deserialize(xml);
                return true;
            }
        ...
        public static bool Deserialize(string xml, out ExceptionCriteriaType obj) {
            System.Exception exception = null;
            return Deserialize(xml, out obj, out exception);
        }
        
        public static ExceptionCriteriaType Deserialize(string xml) {
            System.IO.StringReader stringReader = null;
            try {
                stringReader = new System.IO.StringReader(xml);
                return ((ExceptionCriteriaType)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally {
        ...
        /// <summary>
        /// Serializes current ExceptionCriteriaType object into file
        /// </summary>
        ...
        /// <summary>
        /// Deserializes xml markup from file into an ExceptionCriteriaType object
        /// </summary>
        /// <param name="fileName">string xml file to load and deserialize</param>
        /// <param name="obj">Output ExceptionCriteriaType object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, out ExceptionCriteriaType obj, out System.Exception exception) {
            exception = null;
            obj = default(ExceptionCriteriaType);
            try {
        ...
        public static bool LoadFromFile(string fileName, out ExceptionCriteriaType obj) {
            System.Exception exception = null;
            return LoadFromFile(fileName, out obj, out exception);
        }
        
        public static ExceptionCriteriaType LoadFromFile(string fileName) {
        ...
        #region Clone method
        /// <summary>
        /// Create a clone of this ExceptionCriteriaType object
        /// </summary>
        public virtual ExceptionCriteriaType Clone() {
            return ((ExceptionCriteriaType)(this.MemberwiseClone()));
        }
        #endregion
    }
}
