...
namespace Oasis.Ubl.v21 {
    ...
    public partial class DebitNoteType : System.ComponentModel.INotifyPropertyChanged {
        ...
        private ObservableCollection<DebitNoteLineType> debitNoteLineField;
        ...
        public MonetaryTotalType RequestedMonetaryTotal {
            ...
            set {
                if ((this.requestedMonetaryTotalField != null)) {
                    if ((requestedMonetaryTotalField.Equals(value) != true)) {
                        this.requestedMonetaryTotalField = value;
                        this.OnPropertyChanged("RequestedMonetaryTotal");
                    }
                }
                else {
                    this.requestedMonetaryTotalField = value;
        ...
        public ObservableCollection<DebitNoteLineType> DebitNoteLine {
            get {
                return this.debitNoteLineField;
            }
            set {
                if ((this.debitNoteLineField != null)) {
                    if ((debitNoteLineField.Equals(value) != true)) {
                        this.debitNoteLineField = value;
                        this.OnPropertyChanged("DebitNoteLine");
                    }
                }
                else {
                    this.debitNoteLineField = value;
        ...
        private static System.Xml.Serialization.XmlSerializer Serializer {
            get {
                if ((serializer == null)) {
                    serializer = new System.Xml.Serialization.XmlSerializer(typeof(DebitNoteType));
                }
                return serializer;
            }
        }
        ...
        /// <summary>
        /// Serializes current DebitNoteType object into an XML document
        /// </summary>
        ...
        /// <summary>
        /// Deserializes workflow markup into an DebitNoteType object
        /// </summary>
        /// <param name="xml">string workflow markup to deserialize</param>
        /// <param name="obj">Output DebitNoteType object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool Deserialize(string xml, out DebitNoteType obj, out System.Exception exception) {
            exception = null;
            obj = default(DebitNoteType);
            try {
                obj = Deserialize(xml);
                return true;
            }
        ...
        public static bool Deserialize(string xml, out DebitNoteType obj) {
            System.Exception exception = null;
            return Deserialize(xml, out obj, out exception);
        }
        
        public static DebitNoteType Deserialize(string xml) {
            System.IO.StringReader stringReader = null;
            try {
                stringReader = new System.IO.StringReader(xml);
                return ((DebitNoteType)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally {
        ...
        /// <summary>
        /// Serializes current DebitNoteType object into file
        /// </summary>
        ...
        /// <summary>
        /// Deserializes xml markup from file into an DebitNoteType object
        /// </summary>
        /// <param name="fileName">string xml file to load and deserialize</param>
        /// <param name="obj">Output DebitNoteType object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, out DebitNoteType obj, out System.Exception exception) {
            exception = null;
            obj = default(DebitNoteType);
            try {
        ...
        public static bool LoadFromFile(string fileName, out DebitNoteType obj) {
            System.Exception exception = null;
            return LoadFromFile(fileName, out obj, out exception);
        }
        
        public static DebitNoteType LoadFromFile(string fileName) {
        ...
        #region Clone method
        /// <summary>
        /// Create a clone of this DebitNoteType object
        /// </summary>
        public virtual DebitNoteType Clone() {
            return ((DebitNoteType)(this.MemberwiseClone()));
        }
        #endregion
    }
}
