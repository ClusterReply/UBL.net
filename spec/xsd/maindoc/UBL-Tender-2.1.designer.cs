...
namespace Oasis.Ubl.v21 {
    ...
    public partial class TenderType : System.ComponentModel.INotifyPropertyChanged {
        ...
        private ObservableCollection<PartyType> subcontractorPartyField;
        
        private ContractingPartyType contractingPartyField;
        
        private CustomerPartyType originatorCustomerPartyField;
        
        private ObservableCollection<TenderedProjectType> tenderedProjectField;
        ...
        public TenderTypeCodeType TenderTypeCode {
            ...
            set {
                if ((this.tenderTypeCodeField != null)) {
                    if ((tenderTypeCodeField.Equals(value) != true)) {
                        this.tenderTypeCodeField = value;
                        this.OnPropertyChanged("TenderTypeCode");
                    }
                }
                else {
                    this.tenderTypeCodeField = value;
        ...
        public PartyType TendererParty {
            get {
                return this.tendererPartyField;
            }
            set {
                if ((this.tendererPartyField != null)) {
                    if ((tendererPartyField.Equals(value) != true)) {
                        this.tendererPartyField = value;
                        this.OnPropertyChanged("TendererParty");
                    }
                }
                else {
                    this.tendererPartyField = value;
        ...
        public DocumentReferenceType TendererQualificationDocumentReference {
            get {
                return this.tendererQualificationDocumentReferenceField;
            }
            set {
                if ((this.tendererQualificationDocumentReferenceField != null)) {
                    if ((tendererQualificationDocumentReferenceField.Equals(value) != true)) {
                        this.tendererQualificationDocumentReferenceField = value;
                        this.OnPropertyChanged("TendererQualificationDocumentReference");
                    }
                }
                else {
                    this.tendererQualificationDocumentReferenceField = value;
        ...
        public ObservableCollection<PartyType> SubcontractorParty {
            get {
                return this.subcontractorPartyField;
            }
            set {
                if ((this.subcontractorPartyField != null)) {
                    if ((subcontractorPartyField.Equals(value) != true)) {
                        this.subcontractorPartyField = value;
                        this.OnPropertyChanged("SubcontractorParty");
                    }
                }
                else {
                    this.subcontractorPartyField = value;
        ...
        public ObservableCollection<TenderedProjectType> TenderedProject {
            get {
                return this.tenderedProjectField;
            }
            set {
                if ((this.tenderedProjectField != null)) {
                    if ((tenderedProjectField.Equals(value) != true)) {
                        this.tenderedProjectField = value;
                        this.OnPropertyChanged("TenderedProject");
                    }
                }
                else {
                    this.tenderedProjectField = value;
        ...
        private static System.Xml.Serialization.XmlSerializer Serializer {
            get {
                if ((serializer == null)) {
                    serializer = new System.Xml.Serialization.XmlSerializer(typeof(TenderType));
                }
                return serializer;
            }
        }
        ...
        /// <summary>
        /// Serializes current TenderType object into an XML document
        /// </summary>
        ...
        /// <summary>
        /// Deserializes workflow markup into an TenderType object
        /// </summary>
        /// <param name="xml">string workflow markup to deserialize</param>
        /// <param name="obj">Output TenderType object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool Deserialize(string xml, out TenderType obj, out System.Exception exception) {
            exception = null;
            obj = default(TenderType);
            try {
                obj = Deserialize(xml);
                return true;
            }
        ...
        public static bool Deserialize(string xml, out TenderType obj) {
            System.Exception exception = null;
            return Deserialize(xml, out obj, out exception);
        }
        
        public static TenderType Deserialize(string xml) {
            System.IO.StringReader stringReader = null;
            try {
                stringReader = new System.IO.StringReader(xml);
                return ((TenderType)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally {
        ...
        /// <summary>
        /// Serializes current TenderType object into file
        /// </summary>
        ...
        /// <summary>
        /// Deserializes xml markup from file into an TenderType object
        /// </summary>
        /// <param name="fileName">string xml file to load and deserialize</param>
        /// <param name="obj">Output TenderType object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, out TenderType obj, out System.Exception exception) {
            exception = null;
            obj = default(TenderType);
            try {
        ...
        public static bool LoadFromFile(string fileName, out TenderType obj) {
            System.Exception exception = null;
            return LoadFromFile(fileName, out obj, out exception);
        }
        
        public static TenderType LoadFromFile(string fileName) {
        ...
        #region Clone method
        /// <summary>
        /// Create a clone of this TenderType object
        /// </summary>
        public virtual TenderType Clone() {
            return ((TenderType)(this.MemberwiseClone()));
        }
        #endregion
    }
}
