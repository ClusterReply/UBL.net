...
namespace Oasis.Ubl.v21 {
    ...
    public partial class CallForTendersType : System.ComponentModel.INotifyPropertyChanged {
        ...
        public ApprovalDateType ApprovalDate {
            ...
            set {
                if ((this.approvalDateField != null)) {
                    if ((approvalDateField.Equals(value) != true)) {
        ...
        public PreviousVersionIDType PreviousVersionID {
            ...
            set {
                if ((this.previousVersionIDField != null)) {
                    if ((previousVersionIDField.Equals(value) != true)) {
                        this.previousVersionIDField = value;
                        this.OnPropertyChanged("PreviousVersionID");
                    }
                }
                else {
                    this.previousVersionIDField = value;
        ...
        public DocumentReferenceType LegalDocumentReference {
            ...
            set {
                if ((this.legalDocumentReferenceField != null)) {
                    if ((legalDocumentReferenceField.Equals(value) != true)) {
                        this.legalDocumentReferenceField = value;
                        this.OnPropertyChanged("LegalDocumentReference");
                    }
                }
                else {
                    this.legalDocumentReferenceField = value;
        ...
        public DocumentReferenceType TechnicalDocumentReference {
            ...
            set {
                if ((this.technicalDocumentReferenceField != null)) {
                    if ((technicalDocumentReferenceField.Equals(value) != true)) {
                        this.technicalDocumentReferenceField = value;
                        this.OnPropertyChanged("TechnicalDocumentReference");
                    }
                }
                else {
                    this.technicalDocumentReferenceField = value;
        ...
        private static System.Xml.Serialization.XmlSerializer Serializer {
            get {
                if ((serializer == null)) {
                    serializer = new System.Xml.Serialization.XmlSerializer(typeof(CallForTendersType));
                }
                return serializer;
            }
        }
        ...
        /// <summary>
        /// Serializes current CallForTendersType object into an XML document
        /// </summary>
        ...
        /// <summary>
        /// Deserializes workflow markup into an CallForTendersType object
        /// </summary>
        /// <param name="xml">string workflow markup to deserialize</param>
        /// <param name="obj">Output CallForTendersType object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool Deserialize(string xml, out CallForTendersType obj, out System.Exception exception) {
            exception = null;
            obj = default(CallForTendersType);
            try {
                obj = Deserialize(xml);
                return true;
            }
        ...
        public static bool Deserialize(string xml, out CallForTendersType obj) {
            System.Exception exception = null;
            return Deserialize(xml, out obj, out exception);
        }
        
        public static CallForTendersType Deserialize(string xml) {
            System.IO.StringReader stringReader = null;
            try {
                stringReader = new System.IO.StringReader(xml);
                return ((CallForTendersType)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally {
        ...
        /// <summary>
        /// Serializes current CallForTendersType object into file
        /// </summary>
        ...
        /// <summary>
        /// Deserializes xml markup from file into an CallForTendersType object
        /// </summary>
        /// <param name="fileName">string xml file to load and deserialize</param>
        /// <param name="obj">Output CallForTendersType object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, out CallForTendersType obj, out System.Exception exception) {
            exception = null;
            obj = default(CallForTendersType);
            try {
        ...
        public static bool LoadFromFile(string fileName, out CallForTendersType obj) {
            System.Exception exception = null;
            return LoadFromFile(fileName, out obj, out exception);
        }
        
        public static CallForTendersType LoadFromFile(string fileName) {
        ...
        #region Clone method
        /// <summary>
        /// Create a clone of this CallForTendersType object
        /// </summary>
        public virtual CallForTendersType Clone() {
            return ((CallForTendersType)(this.MemberwiseClone()));
        }
        #endregion
    }
}
