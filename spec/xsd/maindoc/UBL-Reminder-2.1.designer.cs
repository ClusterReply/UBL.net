...
namespace Oasis.Ubl.v21 {
    ...
    public partial class ReminderType : System.ComponentModel.INotifyPropertyChanged {
        ...
        private ObservableCollection<ReminderLineType> reminderLineField;
        ...
        public ReminderTypeCodeType ReminderTypeCode {
            ...
            set {
                if ((this.reminderTypeCodeField != null)) {
                    if ((reminderTypeCodeField.Equals(value) != true)) {
                        this.reminderTypeCodeField = value;
                        this.OnPropertyChanged("ReminderTypeCode");
                    }
                }
                else {
                    this.reminderTypeCodeField = value;
        ...
        public ReminderSequenceNumericType ReminderSequenceNumeric {
            ...
            set {
                if ((this.reminderSequenceNumericField != null)) {
                    if ((reminderSequenceNumericField.Equals(value) != true)) {
                        this.reminderSequenceNumericField = value;
                        this.OnPropertyChanged("ReminderSequenceNumeric");
                    }
                }
                else {
                    this.reminderSequenceNumericField = value;
        ...
        public ObservableCollection<PeriodType> ReminderPeriod {
            ...
            set {
                if ((this.reminderPeriodField != null)) {
                    if ((reminderPeriodField.Equals(value) != true)) {
        ...
        public ObservableCollection<ReminderLineType> ReminderLine {
            get {
                return this.reminderLineField;
            }
            set {
                if ((this.reminderLineField != null)) {
                    if ((reminderLineField.Equals(value) != true)) {
                        this.reminderLineField = value;
                        this.OnPropertyChanged("ReminderLine");
                    }
                }
                else {
                    this.reminderLineField = value;
        ...
        private static System.Xml.Serialization.XmlSerializer Serializer {
            get {
                if ((serializer == null)) {
                    serializer = new System.Xml.Serialization.XmlSerializer(typeof(ReminderType));
                }
                return serializer;
            }
        }
        ...
        /// <summary>
        /// Serializes current ReminderType object into an XML document
        /// </summary>
        ...
        /// <summary>
        /// Deserializes workflow markup into an ReminderType object
        /// </summary>
        /// <param name="xml">string workflow markup to deserialize</param>
        /// <param name="obj">Output ReminderType object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool Deserialize(string xml, out ReminderType obj, out System.Exception exception) {
            exception = null;
            obj = default(ReminderType);
            try {
                obj = Deserialize(xml);
                return true;
            }
        ...
        public static bool Deserialize(string xml, out ReminderType obj) {
            System.Exception exception = null;
            return Deserialize(xml, out obj, out exception);
        }
        
        public static ReminderType Deserialize(string xml) {
            System.IO.StringReader stringReader = null;
            try {
                stringReader = new System.IO.StringReader(xml);
                return ((ReminderType)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally {
        ...
        /// <summary>
        /// Serializes current ReminderType object into file
        /// </summary>
        ...
        /// <summary>
        /// Deserializes xml markup from file into an ReminderType object
        /// </summary>
        /// <param name="fileName">string xml file to load and deserialize</param>
        /// <param name="obj">Output ReminderType object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, out ReminderType obj, out System.Exception exception) {
            exception = null;
            obj = default(ReminderType);
            try {
        ...
        public static bool LoadFromFile(string fileName, out ReminderType obj) {
            System.Exception exception = null;
            return LoadFromFile(fileName, out obj, out exception);
        }
        
        public static ReminderType LoadFromFile(string fileName) {
        ...
        #region Clone method
        /// <summary>
        /// Create a clone of this ReminderType object
        /// </summary>
        public virtual ReminderType Clone() {
            return ((ReminderType)(this.MemberwiseClone()));
        }
        #endregion
    }
}
