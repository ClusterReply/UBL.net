...
namespace Oasis.Ubl.v21 {
    ...
    public partial class TransportProgressStatusRequestType : System.ComponentModel.INotifyPropertyChanged {
        ...
        private static System.Xml.Serialization.XmlSerializer Serializer {
            get {
                if ((serializer == null)) {
                    serializer = new System.Xml.Serialization.XmlSerializer(typeof(TransportProgressStatusRequestType));
                }
                return serializer;
            }
        }
        ...
        /// <summary>
        /// Serializes current TransportProgressStatusRequestType object into an XML document
        /// </summary>
        ...
        /// <summary>
        /// Deserializes workflow markup into an TransportProgressStatusRequestType object
        /// </summary>
        /// <param name="xml">string workflow markup to deserialize</param>
        /// <param name="obj">Output TransportProgressStatusRequestType object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool Deserialize(string xml, out TransportProgressStatusRequestType obj, out System.Exception exception) {
            exception = null;
            obj = default(TransportProgressStatusRequestType);
            try {
                obj = Deserialize(xml);
                return true;
            }
        ...
        public static bool Deserialize(string xml, out TransportProgressStatusRequestType obj) {
            System.Exception exception = null;
            return Deserialize(xml, out obj, out exception);
        }
        
        public static TransportProgressStatusRequestType Deserialize(string xml) {
            System.IO.StringReader stringReader = null;
            try {
                stringReader = new System.IO.StringReader(xml);
                return ((TransportProgressStatusRequestType)(Serializer.Deserialize(System.Xml.XmlReader.Create(stringReader))));
            }
            finally {
        ...
        /// <summary>
        /// Serializes current TransportProgressStatusRequestType object into file
        /// </summary>
        ...
        /// <summary>
        /// Deserializes xml markup from file into an TransportProgressStatusRequestType object
        /// </summary>
        /// <param name="fileName">string xml file to load and deserialize</param>
        /// <param name="obj">Output TransportProgressStatusRequestType object</param>
        /// <param name="exception">output Exception value if deserialize failed</param>
        /// <returns>true if this XmlSerializer can deserialize the object; otherwise, false</returns>
        public static bool LoadFromFile(string fileName, out TransportProgressStatusRequestType obj, out System.Exception exception) {
            exception = null;
            obj = default(TransportProgressStatusRequestType);
            try {
        ...
        public static bool LoadFromFile(string fileName, out TransportProgressStatusRequestType obj) {
            System.Exception exception = null;
            return LoadFromFile(fileName, out obj, out exception);
        }
        
        public static TransportProgressStatusRequestType LoadFromFile(string fileName) {
        ...
        #region Clone method
        /// <summary>
        /// Create a clone of this TransportProgressStatusRequestType object
        /// </summary>
        public virtual TransportProgressStatusRequestType Clone() {
            return ((TransportProgressStatusRequestType)(this.MemberwiseClone()));
        }
        #endregion
    }
}
